...
### Added
- **Response fields reference** in `docs/tools.md` — the JSON shape of every report type, with synthetic examples generated by the server's own parser — thanks [@shoebbagwan](https://github.com/shoebbagwan) ([#9](https://github.com/praveendias1180/easypaydirect-mcp/issues/9), [#14](https://github.com/praveendias1180/easypaydirect-mcp/pull/14))
...
[Unreleased]: https://github.com/praveendias1180/easypaydirect-mcp/compare/v0.1.3...HEAD
[0.1.3]: https://github.com/praveendias1180/easypaydirect-mcp/releases/tag/v0.1.3
